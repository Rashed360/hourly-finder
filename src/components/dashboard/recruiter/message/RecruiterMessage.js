...
const RecruiterMessage = () => {
	...
	const [messages, setMessages] = useState([
		{
			msg: 'Sir, I have sent you my resume. Please review the document and reply me if you like it.',
			time: '08:37 PM',
			sender: false,
		},
		{
			msg: 'Okay. I will review it shortly. :)',
			time: '08:38 PM',
			sender: true,
		},
		{
			msg: 'I have seen it. Its really impresive! But needs some improvements',
			time: '08:49 PM',
			sender: true,
		},
		{
			msg: 'Thank you Sir, Can you suggest me some improvements?',
			time: '08:50 PM',
			sender: false,
		},
	])
							...
							<div className='msg-main'>
								...
								<div className='conversation-text-area'>
									<div className='conversation-text-list'>
										{messages.map((message, idx) => (
											<div
												className={message.sender ? 'conversation-text' : 'conversation-text sender'}
												key={idx}
											>
												<div className='text'>
								...
								<div className='msg-sending-area'>
									...
									<div className='msg-field form-field'>
										<input type='text' placeholder='Write message..' value={input} onChange={onChange} />
