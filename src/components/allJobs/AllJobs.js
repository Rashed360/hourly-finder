										...
										<div className='g-0 row align-items-center'>
											<div className='col-lg-5'>
												<div className='search-by'>
													...
													<span>
														<span className='iconify' data-icon='fa-solid:search-location'></span>
													</span>
												</div>
											</div>
											<div className='col-lg-3'>
												<div className='search-by'>
													...
													<span>
														{' '}
														<span className='iconify' data-icon='ci:location'></span>
													</span>
												</div>
											</div>
											<div className='col-lg-2'>
												<div className='search-by'>
													...
													<span>
														<span className='iconify' data-icon='bx:bxs-briefcase'></span>
													</span>
												</div>
											</div>
											<div className='col-lg-2'>
