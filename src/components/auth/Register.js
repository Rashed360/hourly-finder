								...
								<Form onSubmit={handleSubmit} onReset={handleReset} style={{ height: '300px' }}>
									...
									{step.current === 1 && (
										<div className='form-field account-type'>
											...
											<div className='group' role='group' aria-labelledby='my-radio-group'>
												<label className={values.accountType === '1' && 'active'}>
													<FaUserGraduate />
													<Field type='radio' name='accountType' value='1' />
													Job Seeker
												</label>
												<label className={values.accountType === '2' && 'active'}>
													<FaUserTie />
											...
											{values.accountType === '' ? (
												...
												<p className='msg'>
													<FaInfoCircle /> {values.accountType==='1' ? 'I am Looking for Jobs' : 'I am Looking for Employees'}
												</p>
											)}
										</div>
									)}
									{step.current === 5 && (
										<>
											...
											<ul>
												<li>
													<FaUserCircle /> {values.firstName ? values.firstName : 'No Name'} {values.lastName}
												</li>
												<li>
													<FaBriefcase /> {values.accountType} (
