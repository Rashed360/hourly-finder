...
const mapDispatchToProps = dispatch => {
	return {
		jobSingleFetch: id => dispatch(jobSingleFetch(id)),
	}
}

const mapStateToProps = state => {
	return {
		singleJob: state.job.singleJob,
	}
}
	...
	const recruiters = [
		{
			...
			gallery_img: [
				'/images/singlejobpage/cover/cover-1.jpg',
				'/images/singlejobpage/photo-gallery/31917962768_c979352217_b.jpg',
			],
		},
	]
